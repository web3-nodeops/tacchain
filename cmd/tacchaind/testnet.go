...
// 	ethermintnetwork "github.com/evmos/ethermint/testutil/network"
...
// 	ethermintJsonRpcAddress string
// }
...
// 	cmd.Flags().String(flags.FlagKeyType, string(etherminthd.EthSecp256k1Type), "Key signing algorithm to generate keys for")
...
// 			args.ethermintJsonRpcAddress, _ = cmd.Flags().GetString(ethermintsrvflags.JSONRPCAddress)
...
// 	cmd.Flags().String(ethermintsrvflags.JSONRPCAddress, ethermintconfig.DefaultJSONRPCAddress, "the JSON-RPC server address to listen on")
...
// 	appConfig := ethermintconfig.DefaultConfig()
...
// 		kb, err := keyring.New(sdk.KeyringServiceName(), args.keyringBackend, nodeDir, inBuf, clientCtx.Codec, etherminthd.EthSecp256k1Option())
// 		if err != nil {
// 			return err
// 		}
...
// 	evmGenState.Params.ExtraEIPs = []int64{3855}
// 	appGenState[evmtypes.ModuleName] = clientCtx.Codec.MustMarshalJSON(&evmGenState)

// 	var consensusParams consensusparamtypes.QueryParamsResponse
// 	if len(appGenState[consensusparamtypes.ModuleName]) > 0 {
// 		clientCtx.Codec.MustUnmarshalJSON(appGenState[consensusparamtypes.ModuleName], &consensusParams)
// 		consensusParams.Params.Block.MaxGas = 20000000
// 	} else {
// 		consensusParams.Params = simtestutil.DefaultConsensusParams
// 	}
// 	appGenState[consensusparamtypes.ModuleName] = clientCtx.Codec.MustMarshalJSON(&consensusParams)
...
// 	networkConfig.JSONRPCAddress = args.ethermintJsonRpcAddress
